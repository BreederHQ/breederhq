          ...
          <>
            ...
            >
                  ...
                  filtered.map((t) => {
                    ...
                    return (
                      <button
                        ...
                        onClick={() => onToggle(t)}
                        className={[
                          "w-full grid grid-cols-[1fr_auto] items-center gap-2 px-3 py-2 text-left hover:bg-[hsl(var(--brand-orange))]/12",
                          on ? "font-medium" : "",
                        ].join(" ")}
                      >
              ...
              <div className="p-2 border-t border-hairline text-right">
                <components.Button variant="outline" size="sm" onClick={() => setOpen(false)}>
                  Close
                </components.Button>
              </div>
            </div>
